 ...
 * 
 * The load gets generated by the {@link ScpLoadData} object.
 * 
 * @author Julien Malvot
 * 
 */
public class ScpHighloadComponent extends ScpDeploymentComponent {
	 ...
	 */
	public ScpHighloadComponent(String id, ENetworkId networkId) {
		super(id, networkId);
		this.machineId = null;
		this.osLoadData = new ScpLoadData(1.0);
	}
	
	public ScpHighloadComponent(String id, ENetworkId networkId, List<String> onAppIds) {
		super(id, networkId);
		this.machineId = null;
		this.osLoadData = new ScpLoadData(1.0);
