 ...
 * 
 */
public class LocalLauncherComplexBalanceDeploymentNoJPF {
	...
	public static void main(String[] args) {
		...
		cloudComponents.add(new AppBalanceDeploymentComponent("APP3"));
		cloudComponents.add(new AppBalanceDeploymentComponent("APP4"));
