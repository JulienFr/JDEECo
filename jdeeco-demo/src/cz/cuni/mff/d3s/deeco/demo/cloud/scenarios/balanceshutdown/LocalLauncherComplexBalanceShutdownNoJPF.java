 ...
 *
 */
public class LocalLauncherComplexBalanceShutdownNoJPF {
	/**
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		...
		List<Class<?>> ensembles = Arrays.asList(new Class<?>[] { 
				...
				SelectScpComponentsForShutdownEnsemble.class
		});
		...
		cloudComponents.add(new AppBalanceShutdownComponent("APP1", new AppShutdownBalancer(Arrays.asList("APP1","APP2","APP3"))));
		cloudComponents.add(new AppBalanceShutdownComponent("APP2"));
		cloudComponents.add(new AppBalanceShutdownComponent("APP3"));
